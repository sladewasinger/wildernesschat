...
export class ChunkRenderer {
  ...
  constructor(
    ...
    this.terrainSurface = new TerrainSurfaceRenderer(terrain, colorSampler);
    this.overlays = new FeatureOverlayRenderer(config, terrain, rivers, settlements, debug, treeSeed, fieldSeed);
  }
  ...
  renderChunk(chunkX: number, chunkY: number): HTMLCanvasElement {
    ...
    this.terrainSurface.render(ctx, startX, startY, chunkSize, step);
    this.overlays.draw(ctx, chunkX, chunkY, startX, startY, chunkSize);
    return canvas;
  }
}
